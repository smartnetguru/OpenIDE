...
namespace OpenIDE.Core.Localisation.Plural
{
    /// <summary>
    ...
    public class PluralFormProcessor
    {
        ...
        {
            _CustomFormulas.Add(cultureInfo.LCID, formula);
        }
        ...
        {
            Trace.WriteLine(
                String.Format("Getting plural index for locale \"{0}\" and number \"{1}\".", cultureInfo.Name, number),
                "Lib.Gettext");

            if (_CustomFormulas.ContainsKey(cultureInfo.LCID))
            {
                FormulaDelegate formula = _CustomFormulas[cultureInfo.LCID];
                if (formula != null)
                {
                    Trace.WriteLine(String.Format("Using custom plural formula for locale \"{0}\".", cultureInfo.Name),
                                    "Lib.Gettext");
                    return formula.Invoke(number);
                }
            }

            string langCode = cultureInfo.TwoLetterISOLanguageName;
            Trace.WriteLine(
                String.Format("Using built-in plural formula with langcode \"{0}\" for locale \"{1}\".", langCode,
                              cultureInfo.Name), "Lib.Gettext");
            ...
            switch (langCode)
            {
                ...
                case "ga":
                    return (number == 1)
                               ...
                               : ((number == 2)
                                      ? 1
                                      : (((number >= 3) && (number <= 6)) ? 2 : ((number >= 7 && number <= 10) ? 3 : 4)));
                ...
                case "sl":
                    return (number%100 == 1)
                               ? 0
                               : ((number%100 == 2) ? 1 : (((number%100 == 3) || (number%100 == 4)) ? 2 : 3));
                ...
                case "cy":
                    return (number == 0)
                               ...
                               : ((number == 1)
                                      ? 1
                                      : ((number == 2) ? 2 : ((number == 3) ? 3 : ((number == 6) ? 4 : 5))));
                ...
                case "gd":
                    return ((number == 1) || (number == 11))
                               ...
                               : (((number == 2) || (number == 12))
                                      ? 1
                                      : (((((number >= 3) && (number <= 10)) || ((number >= 13) && (number <= 19)))
                                              ? 2
                                              : 3)));
