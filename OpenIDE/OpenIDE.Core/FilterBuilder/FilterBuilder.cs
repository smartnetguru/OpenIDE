...
namespace OpenIDE.Core
{
    ...
    public class FilterBuilder
    {
        ...
        /// </summary>
        public int Count => sFilters.Count;
        ...
        /// </returns>
        public bool Contains(Filters filter) => sFilters.Contains(Helpers.ReturnFilterAsString(filter));
        ...
        public int GetFilterIndex(Filters filter) => (sFilters.IndexOf(Helpers.ReturnFilterAsString(filter)) > -1)
        ...
        /// </param>
        /// <returns>The filter index to use.</returns>
        public int GetFilterIndex(string filter) => (sFilters.IndexOf(filter) > -1) ? (sFilters.IndexOf(filter) + 1) : 1;
        /// <summary>
        /// Returns the first string of the first item.
        /// </summary>
        public string GetFirstItem() => sFilters.Count > 0 ? sFilters[0] : string.Empty;

        /// <summary>
        /// Returns the first string of the last item.
        /// </summary>
        public string GetLastItem() => sFilters.Count > 0 ? sFilters[sFilters.Count - 1] : string.Empty;
